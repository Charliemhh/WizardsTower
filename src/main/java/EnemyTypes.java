public class EnemyTypes {
    public static Enemy generateEnemy(int enemyTypeID) {
        switch (enemyTypeID) {
            case 0://Bag O'Bones
                Enemy BagOBones = new Enemy("Bag O'Bones",10, 4, 0);
                BagOBones.getStatBlock().generateEnemyStats(enemyTypeID);
                return BagOBones;
            case 1://Werechicken
                Enemy Werechicken = new Enemy("Were-Chicken",15, 6, 1);
                Werechicken.getStatBlock().generateEnemyStats(enemyTypeID);
                return Werechicken;
            case 2: //Smart-Mouthed Slime
                Enemy SmartMouthedSlime = new Enemy("Smart-Mouthed Slime",20, 4, 2);
